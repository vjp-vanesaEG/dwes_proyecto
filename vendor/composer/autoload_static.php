...
class ComposerStaticInit8d070178755c320c69f93ee4800660ef
{
    ...
    public static $classMap = array (
        ...
        'proyecto\\entities\\App' => __DIR__ . '/../..' . '/entities/App.php',
        'proyecto\\entities\\Categoria' => __DIR__ . '/../..' . '/entities/Categoria.php',
        'proyecto\\entities\\Connection' => __DIR__ . '/../..' . '/entities/Connection.php',
        'proyecto\\entities\\File' => __DIR__ . '/../..' . '/entities/File.php',
        'proyecto\\entities\\ImagenGaleria' => __DIR__ . '/../..' . '/entities/ImagenGaleria.php',
        'proyecto\\entities\\Mensaje' => __DIR__ . '/../..' . '/entities/Mensaje.php',
        'proyecto\\entities\\Partners' => __DIR__ . '/../..' . '/entities/Partners.php',
        'proyecto\\entities\\QueryBuilder' => __DIR__ . '/../..' . '/entities/QueryBuilder.php',
        'proyecto\\entities\\Request' => __DIR__ . '/../..' . '/entities/Request.php',
        'proyecto\\entities\\Router' => __DIR__ . '/../..' . '/entities/Router.php',
        'proyecto\\entities\\repository\\MyLog' => __DIR__ . '/../..' . '/entities/repository/MyLog.php',
    );
